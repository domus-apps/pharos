...
ITEM=$(mktemp)
{
    cat <<EOF
    <item>
      <title>Pharos v$VERSION</title>
      <link>https://github.com/domus-apps/pharos/releases/tag/v$VERSION</link>
...
EOF
    ...
    cat <<EOF
      ...
      <enclosure
        url="https://github.com/domus-apps/pharos/releases/download/v$VERSION/Pharos.zip"
        $SIGNATURE_ATTRS
